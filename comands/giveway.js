...
module.exports.run = async (bot, message, args) => {
    ...
    if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("Sorry jij kan dit comando niet uitvoeren!");
    ...
    setTimeout(function () {
        ...
        for (var i = 0; i < winners.length; i++) {
            message.channel.send("Gefeliciteerd " + winners[i] + `! :) **${item}**.`);
        }
